...
def car_number():
    ...
    if car != 'unknown':
        text = f"Kya aapkai car ka number {car} hai? Kripya haan ya na mein jawab dein."
    else:
...
def service():
    ...
    if is_yes(speech):
        ...
        if svc and 'next_service_date' in svc:
            ...
            text = f"Aapki car service ki due date {date_str} thi . Kya aap dusre date ko  schedule karna chahte hai?"
        else:
