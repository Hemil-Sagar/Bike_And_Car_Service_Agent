...
def voice():
    ...
    r = VoiceResponse()
    text = "Namaste! Main Sarthi Toyota ka AI agent bol rahi hoon. Aapki car service ke liye call kar rahi hoon."
...
def car_number():
    ...
    if car != 'unknown':
        text = f"Kya aapki car ka number {car} hai? Kripya haan ya na mein jawab dein."
    else:
...
def reschedule_date():
    ...
    text = f"Perfect! Aapki car service {formatted} ko reschedule kar di gayi hai."
